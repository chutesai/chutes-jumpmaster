...
Usage:
  ...
  3. Run route discovery: python tools/discover_routes.py --chute-file deploy_<yourservice>.py
  4. Build and deploy: chutes push deploy_<yourservice>.py
...
# If no manifest exists yet, run: python tools/discover_routes.py --chute-file <this_file>
